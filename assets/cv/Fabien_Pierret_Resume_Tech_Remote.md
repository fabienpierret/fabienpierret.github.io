...
**ML Engineer / Data Engineer | Remote Specialist**

New York, NY 10009 | fabien84.p@me.com | (646) 698-2777  
**GitHub**: github.com/fabienpierret | **Portfolio**: fabienpierret.github.io
...
### **ML Engineer / Data Engineer** (Personal Projects) | 2023 - Present
**Remote | Independent Projects**
...
**Technologies**: Python, Polars, Parquet, XGBoost, CatBoost, Asyncio, CCXT, ETL Pipeline
...
**Technologies**: Python, CoreML, YOLO, SAM2, Computer Vision, OCR, Rust (performance-critical components)
...
**Technologies**: Python, Solana RPC, Jito, Borsh, Flash-loan stack
